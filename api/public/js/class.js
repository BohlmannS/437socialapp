$(document).ready(function(){
	...
	x.then(function(data){
		...
		$('#classTitle').html(data.headInfo);
		if(data.yourSection==='') $('#class-data').html('<p>You have no friends in your section</p>');
		else $('#class-data').html(data.yourSection);
		if(data.otherSection==='') $('#mutual-data').html('<p>You have no friends in other sections</p>');
		else $('#mutual-data').html(data.otherSection);
	})
