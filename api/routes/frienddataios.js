...
router.post('/', function(req, res) {
        ...
        let sql = 'select class1, class2, class3, class4, class5, class6, class7, class8, class9, class10 from schedules inner join users on schedules.uid=users.uid where username=\'' + username+'\'';
